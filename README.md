...
<h1>Monte Carlo Localization 5000</h1>
...
<div class="layout">
  ...
  <div class="sidebar">
    <div class="panel">
      ...
      <div class="stat-row"><span class="stat-label">Particles</span><span class="stat-val">5000</span></div>
    </div>
...
const N_OBJ_SAMPLES  = 5000;   // visual uncertainty cloud sample count
